...
class LINE:
  ...
  def __init__(self):
    ...
    self._headers = {'X-Line-Application': 'DESKTOPWIN 8.2.2 BotEater x64.'}    
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {
              'X-Line-Application': 'DESKTOPWIN 8.2.2 BotEater x64.', 
              'X-Line-Access': self.authToken, 
              'User-Agent': 'DESKTOPWIN\t9.0.3Bot-Eater\t17.09'
   }
